  ...
  return (
    <footer
      className={`w-full border-t ${
        theme === 'dark'
          ? 'bg-[#131D17] text-[#E9E8E6] border-[#415848]/35'
          : 'bg-[#F3EBDD] text-[#2C2A29] border-[#D8CFC0]/45'
      }`}
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className={`transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`} aria-label="Twitter">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
                </svg>
              </a>
              <a href="#" className={`transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`} aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="#" className={`transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`} aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/" className={`text-sm transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`}>Meditation Timer</Link></li>
              <li><Link href="/breathing-exercise" className={`text-sm transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`}>4-7-8 Breathing</Link></li>
              <li><Link href="/blog" className={`text-sm transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`}>Blog</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/privacy-policy" className={`text-sm transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`}>Privacy Policy</Link></li>
              <li><Link href="/terms-of-service" className={`text-sm transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`}>Terms of Service</Link></li>
              <li><Link href="/contact" className={`text-sm transition-colors duration-200 hover:text-[#6B8F7A] ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`}>Contact Us</Link></li>
            </ul>
          </div>
        </div>
              ...
              return (
                <a
                  ...
                  className={`group flex flex-col items-center justify-center p-4 rounded-xl transition-all duration-300 hover:scale-105 ${
                    theme === 'dark'
                      ? 'neumorphic-dark-inset border border-[#4A5E54]/30 hover:border-[#6B8F7A]/45'
                      : 'neumorphic-inset border border-[#D8CFC0]/45 hover:border-[#6B8F7A]/45'
                  }`}
            ...
            <p className={`text-xs ${theme === 'dark' ? 'text-neumorphic-muted-dark' : 'text-neumorphic-muted-light'}`}>
              ...
              <a
                ...
                className={`underline hover:no-underline transition-colors duration-200 ${
                  theme === 'dark' ? 'text-[#A8C8B0] hover:text-[#C5BBA7]' : 'text-[#6B8F7A] hover:text-[#7FA87C]'
                }`}
              >
                Get in touch
              </a>
