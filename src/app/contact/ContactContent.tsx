      ...
      <div>
        ...
        <div className={`rounded-2xl p-8 md:p-12 mb-12 text-center ${
          ...
          <p className={`text-lg mb-6 ${theme === 'dark' ? 'text-neumorphic-tips-dark' : 'text-neumorphic-tips-light'}`}>
            We&apos;d love to hear from you! Whether you have feedback, questions, or just want to share your meditation journey, reach out to us directly via email.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className={`p-8 md:p-12 rounded-2xl text-center mb-8 ${
            ...
            <h2 className={`text-3xl font-light mb-4 ${theme === 'dark' ? 'text-neumorphic-tips-dark' : 'text-neumorphic-tips-light'}`}>
              Get in Touch
            </h2>
            <p className={`text-lg mb-8 ${theme === 'dark' ? 'text-neumorphic-tips-dark' : 'text-neumorphic-tips-light'}`}>
              For any questions, feedback, or support, please email us directly:
            </p>
            <a
